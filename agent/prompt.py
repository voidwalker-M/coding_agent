...
Path: {repo_path}
{repo_summary}
{retrieved_section}{memory_section}{working_memory_section}
## Available tools
{tool_descriptions}
"""
...
def build_system_prompt(
    ...
    Args:
        ...
        memory_context:    long-term memory — the MEMORY.md index + recalled records
                           relevant to the task (stable per task; optional)
        working_memory:    short-term working memory for this run — notes, files
                           examined, and a rolling summary of trimmed turns (optional)
